...
class _ManageQuestionsScreenState extends State<ManageQuestionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          '${AppLocalizations.of(context)?.manageQuestionsPrefix ?? 'Gérer les questions'} - ${widget.themeName}',
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, i) {
          ...
          return ListTile(
            ...
            subtitle: Text(
              '${AppLocalizations.of(context)?.idLabel ?? 'ID'}: ${q.id} • ${AppLocalizations.of(context)?.tagsLabel ?? 'Tags'}: ${q.tags.join(', ')}',
